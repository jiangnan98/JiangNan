...
public class Service {
    ...
    //是否正常
    Map<BufferedReader,Boolean> mapList = new HashMap<>();
    //输入流列表集合
        ...
        public void run() {
            while(mapList.get(bReader)) {
                ...
                try {
                    ...
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                    System.out.println("进程阻断");
                    mapList.put(bReader,false);
                    bReaders.remove(bReader);
                }
            }
        }
    }
