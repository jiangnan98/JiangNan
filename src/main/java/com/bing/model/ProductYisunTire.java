...
@TableName("t_product_yisun_tire")
public class TProductYisunTire extends Model<TProductYisunTire> {
    ...
    /**
     * 速度级别 L、M、N、P、Q、R、S、T、U、H、V、W、Y、ZR
     */
     ...
     * 胎面宽
     */
    @TableField("tread_width")
    private String treadWidth;

    /**
     * 扁平比
     */
    @TableField("flat_ratio")
